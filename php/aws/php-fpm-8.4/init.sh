...
yum-config-manager --setopt="remi-php84.priority=5" --enable remi-php84
...
#Install PHP-FPM 8.4
yum install -y tidy php84-php-fpm php84-php-common php84-php-sodium \
...
cd ioncube/
cp ioncube_loader_lin-musl_8.4.so /opt/remi/php84/root/usr/lib64/php/modules/
...
echo "zend_extension=/opt/remi/php84/root/usr/lib64/php/modules/ioncube_loader_lin-musl_8.4.so" >>/etc/opt/remi/php84/php.ini
